            ...
            <div class="main-page">
                            ...
                            <div class="process candidate">
                                <div class="step">
                                    ...
                                    <a href="applicationList.jsp">
                                        <center>
                                            <img src="images/grid/NewIntake.png" class="filtered img-rounded"
                                                 height="100" width="100" alt="Avatar" style="padding-right: 10px">
                                        </center>
                                    </a>
                                </div>
                        ...
                        <div class="process interview">
                            <div class="step">
                                ...
                                <a id="ArchiveExecutionNavigation" href="ArchiveExecutionDetails_Governance.jsp">
                                    <center>
                                        <img src="images/grid/archival-execution.png" class="filtered img-rounded"
                                             height="100" width="100" alt="Avatar">
                                    </center>
                                </a>
                            </div>
                            <br> <span class="step-title"> Archive Execution <br></span>
                        </div>
                </div>
                ...
                <div class="process assessment">
                    <div class="step">
                        ...
                        <a href="Report.jsp">
                            <center>
                                <img src="images/governance/Report%20Generate.png" class="filtered img-rounded"
                                     height="100"
