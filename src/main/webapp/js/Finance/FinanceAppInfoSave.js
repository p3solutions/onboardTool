...
$("#legacyAppInfoSave").click(function(e)
{
    ...
    var jsonObj = [];
        ...
        if(checkMandatory){
           FinanceAppInfoAjaxCallUpdate(JsonString,checkMandatory,e);
        }
        else{
            notification("warning","Please fill the mandatory fields in Application Info.","Warning : ");
            e.preventDefault();
        }
    document.getElementById("next").disabled = false;
});
function FinanceAppInfoAjaxCallUpdate(JsonString,checkMandatory,e)
{
    e.preventDefault();
    var JsonObject=[];
    var checkAjax =false;
