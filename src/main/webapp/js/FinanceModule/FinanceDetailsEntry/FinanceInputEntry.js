...
$("#Submit").click(function(e) {
	...
	console.log("The value of Function Session : ", Id)
	...
	if (AppName != "") {
		...
		var checkAjax;
		var validationCheck_json = AjaxCallUpdate(Id, AppName, JsonString, checkMandatory, CheckExistance, CheckAppname, e);
...
function AjaxCallUpdate(Id, AppName, JsonString, checkMandatory, CheckAPPID, checkAppname, e) {
	e.preventDefault();
	var JsonObject = [];
	var checkAjax = false;
	$.ajax({
		...
		type: 'POST',
		data: { Id: Id, AppName: AppName, JsonString: JsonString, checkMandatory: checkMandatory },
		async: false,
		dataType: "json",
