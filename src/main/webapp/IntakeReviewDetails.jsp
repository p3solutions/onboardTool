                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="sub-title" style="color: #fff">
                            <a href="OpportunityList.jsp" id="sitetitle1" style="color: #fff"><span
                                ...
                                href="OpportunityList.jsp" id="sitetitle1"
                                style="color: #fff"><%=Encode.forHtml(OpportunityName)%>
                        </a>>><a
                                        ...
                                        <form action="" method="post" role="form">
                                            ...
                                            <div class="form-wizard-header nav-font">
                                                ...
                                                <ul class="list-unstyled form-wizard-steps clearfix">
                                                    <li class="activated"
                                                        onclick="location.href='IntakeOpportunity.jsp;'">
                                                        <span>1</span><i>Opportunity</i></li>
                                                    <li class="activated"
                                                        onclick="location.href='IntakeTriage.jsp';"><span>2</span><i>Triage</i>
                                                    </li>
                                                    <li class="activated"
                                                        onclick="location.href='IntakeTriageSummary.jsp';">
                                                        <span>3</span><i>Triage
                                                        Summary</i></li>
                                                    <li class="activated"
                                                        onclick="location.href='IntakeAssessment.jsp';">
                                                        <span>4</span><i>Assessment</i></li>
                                                    <li class="activated"
                                                        onclick="location.href='IntakeStakeHolder.jsp';"><span>5</span>
                                                        <i>Stake Holder</i></li>
                                                    <li class="active"
                                                        onclick="location.href='IntakeReviewDetails.jsp';">
                                                        <span>6</span><i>Review</i></li>
                                                    <li onclick="location.href='IntakeApproval.jsp';"
                                                        class="ReviewNextBtn"><span>7</span><i>Approval</i></li>
                                                </ul>
                                            </div>
                                            <div class="card-container card">
                                                <div class="card-header" id="cd-header">
                                                    Intake Summary
                                                    <button id="exportPdf" class="btn btn-primary align-right"
                                                ...
                                                <div class="panel-collapse"
                                                    ...
                                                    <div class="panel-body">
                                                        ...
                                                        <tr align='left'>
                                                            <td style='color:#404041;font-size:12px;line-height:16px;padding:10px 16px 20px 18px'>
                                                                <h3 class="panel-title">Triage Summary Information</h3>
                                                                <br>
                                                                <div id="TriageSummInfoPreview"><br></div>
                                                    </div>
                                                    </td> </tr>

                                                    <tr align='left'>
                                                        <td style='color:#404041;font-size:12px;line-height:16px;padding:10px 16px 20px 18px'>
                                                            <div id="AssessInfoPreview"><h2 class="panel-title">
                                                                Assessment Information</h2> <br>
                                            ...
                                            <h3 class="panel-title" style="display:none;" id="contract_info_heading">
                                                Contract Information</h3><br>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <button type="button" class="btn btn-secondary" id="ReviewPrevBtn"
                                            onclick="location.href='IntakeStakeHolder.jsp';">Prev
                                    </button>
                                </div>
                                <div class="col-6" align="end">
                                    ...
                                    <button type="button" class="btn btn-primary"
                                            onclick="location.href='IntakeApproval.jsp';" id="ReviewNextBtn">Next
                                    </button>
                                </div>
                            </div>
        ...
        <div id="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel" style="text-align: center"><b>List of
                    Users</b></h4>
                <input type="checkbox" name="signorder" id="signorder" style="margin-left: 245px;"> <b>Set signing
                order</b>
