...
public class LoginService {
    ...
    private static void tableCreation() throws SQLException {
        ...
        try {
            ...
            PreparedStatement st7 = null, st8 = null, stTriSumm = null, AssDataCharst = null, stAbbTemplate = null;
            ResultSet rs7 = null, rs8 = null, rsTriSumm = null, AssDataCharrs = null, rsAbbTemp = null;
...
//            }
            ...
            logger.debug("Exception in LoginService", e);
        }
        finally {
            con.close();
    ...
    protected void licenseValidation(HttpSession details, HttpServletResponse response, String role) throws SQLException, ClassNotFoundException, IOException, ParseException {
        ...
        config.setPassword("Decom3Sixty");
        ...
        //prints dates
        logger.info("Current Date : " + sdf.format(cur_date));
        logger.info("License valid till: " + sdf.format(lic_valid_date));

        if (cur_date.before(lic_valid_date) || cur_date.equals(lic_valid_date)) {

            details.setAttribute("role", role);
            ...
            String pagename = (String) details.getAttribute("pageUrl");
            if (pagename != null) {
            ...
            logger.error("Error in licenseValidation method");
        }
        con.close();
        logger.info("DB Connection Closed...");
    }
