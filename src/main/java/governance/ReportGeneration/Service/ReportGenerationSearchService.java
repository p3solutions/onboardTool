...
public class ReportGenerationSearchService {
	...
	public JsonObject fetchDataForIntakeReport1(String page, String maxRows, String searchValue, String columnName) throws SQLException {
        ...
        try {
            ...
            String query = "SELECT * FROM decom3sixtytool.Intake_Report_1 where "+columnName+" like ? LIMIT ?,?;";
	...
	public JsonObject fetchDataForIntakeReport2(String page, String maxRows, String searchValue, String columnName) throws SQLException {
        ...
        try {
            ...
            String query = "SELECT * FROM decom3sixtytool.Intake_Report_2 where "+columnName+" like ? LIMIT ?,?;";
            st = connection.prepareStatement(query);
            st.setString(1, "%"+searchValue+"%");
            st.setInt(2, start);
            st.setInt(3, MaxRows);
            ...
            String countQuery = "SELECT COUNT("+columnName+") AS total FROM decom3sixtytool.Intake_Report_2 Where "+columnName+" Like ?";
            st1 = connection.prepareStatement(countQuery);
            st1.setString(1, "%"+searchValue+"%");
            rs1 = st1.executeQuery();
            if (rs1.next()) {
	...
	public JsonObject fetchDataForIntakeReport3(String page, String maxRows, String searchValue, String columnName) throws SQLException {
        ...
        try {
            ...
            String countQuery = "SELECT COUNT("+columnName+") AS total FROM decom3sixtytool.Intake_Report_3 Where "+columnName+" Like ?";
            st1 = connection.prepareStatement(countQuery);
            st1.setString(1, "%"+searchValue+"%");
            rs1 = st1.executeQuery();
            if (rs1.next()) {
