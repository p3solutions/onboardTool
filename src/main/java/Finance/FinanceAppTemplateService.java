    ...
    public void financeAppTemplate() throws SQLException {
        ...
        try {
            ...
            if(!rs_finance.next())
            {
                ...
                finance[3] = new FinanceTemplateInfo(4,",Yes,No","Software and Licensing", "softlicense", "Dropdown", "No", "");
                finance[4] = new FinanceTemplateInfo(5,"","Software and Licensing(cost Saving) ($)", "softlicensecost", "Text box", "No", "");
                finance[5] = new FinanceTemplateInfo(6,"","Contract end date", "contractDate", "Datepicker", "No", "");
                finance[6] = new FinanceTemplateInfo(7,"","Contract end date -comments", "contractDateComment", "Text box", "No", "");
                finance[7] = new FinanceTemplateInfo(8,"","Scope of infrastructure", "scopeinfra", "Text box", "No", "");
                finance[8] = new FinanceTemplateInfo(9,"","Infrastructure Cost Savings ($)", "infrastructurecostsavings", "Text box", "No", "");
                ...
                finance[11] = new FinanceTemplateInfo(12,"","Total CBA ($)", "cba", "Text box", "No", "");
                finance[12] = new FinanceTemplateInfo(13,",Yes,No","Funding approved?", "fundapprove", "Dropdown", "Yes", "");
                finance[13] = new FinanceTemplateInfo(14,"","Funding Type", "fundtype", "Text box", "No", "");
