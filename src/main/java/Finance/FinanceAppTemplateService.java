...
public class FinanceAppTemplateService {
    ...
    public void financeAppTemplate() throws SQLException {
        ...
        try {
            ...
            if(!rs_finance.next())
            {
                FinanceTemplateInfo finance[] = new FinanceTemplateInfo[16];
                ...
                finance[3] = new FinanceTemplateInfo(4,"","Software and Licensing", "softlicense", "Text box", "Yes", "");
                ...
                finance[15] = new FinanceTemplateInfo(16,"","Ability to pull up archive target and input financial information", "archivetarget", "Text box", "Yes", "");
