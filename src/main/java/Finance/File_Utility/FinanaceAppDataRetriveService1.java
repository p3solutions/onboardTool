...
public class FinanaceAppDataRetriveService1 {
    DBconnection dBconnection;
    Connection con;
    public String Id = null;
    public String oppName = null;

    public FinanaceAppDataRetriveService1(String Id, String oppName) throws ClassNotFoundException, SQLException {
    ...
    public FinanaceAppDataRetriveService1() throws SQLException, ClassNotFoundException, SQLException {
        dBconnection = new DBconnection();
        con = (Connection) dBconnection.getConnection();
    }
