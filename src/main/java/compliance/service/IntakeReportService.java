...
public class IntakeReportService {
	...
	public JsonObject fetchDataForIntakeReport1(String page, String maxRows) throws SQLException {
        ...
        try {
            ...
            String query = "SELECT * FROM Intake LIMIT ?, ?";
            ...
            String countQuery = "SELECT COUNT(*) AS total FROM Intake";
	...
	public JsonObject fetchDataForIntakeReport2(String page, String maxRows) throws SQLException {
        ...
        try {
            ...
            String query = "SELECT * FROM Intake_Triage LIMIT ?, ?";
            st = connection.prepareStatement(query);
            st.setInt(1, start);
            st.setInt(2, MaxRows);
            ...
            String countQuery = "SELECT COUNT(*) AS total FROM Intake_Triage";
            st1 = connection.prepareStatement(countQuery);
            rs1 = st1.executeQuery();
            if (rs1.next()) {
                totalCount = rs1.getInt("total");
	...
	public JsonObject fetchDataForIntakeReport3(String page, String maxRows) throws SQLException {
        ...
        try {
            ...
            String query = "SELECT * FROM Requirements LIMIT ?, ?";
            st = connection.prepareStatement(query);
            st.setInt(1, start);
            st.setInt(2, MaxRows);
            ...
            String countQuery = "SELECT COUNT(*) AS total FROM Requirements";
            st1 = connection.prepareStatement(countQuery);
            rs1 = st1.executeQuery();
            if (rs1.next()) {
                totalCount = rs1.getInt("total");
