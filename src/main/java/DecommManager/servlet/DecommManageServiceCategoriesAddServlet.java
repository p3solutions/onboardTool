    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if(labelcheck){
                ...
                DecommManageExecuteInfoService.DecommManageServiceCategoriesAddService(projectname, applicationname, label_name,  mandatory, type, NumberofInputfields, option);
            }
