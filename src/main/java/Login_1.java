...
public class Login_1 extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		class Role {
			...
			Role(String role, String admin, String app_emp, String intake, String arch_exe, String decomm,
					String prgm_governance, String reporting, String finance) {
				this.role = role;
				this.admin = admin;
		...
		class OpportunityDetails {
			...
			OpportunityDetails(int seq_num, String project, String app_name, String options, String label,
					String column, String type, String mandatory, String value) {
				this.seq_num = seq_num;
		...
		class GovernanceDetails {
			...
			GovernanceDetails(int seq_num, String options, String label, String column, String type, String mandatory,
					String value) {
				this.seq_num = seq_num;
				this.options = options;
				this.label = label;
		...
		class Triage {
			...
			Triage(int seq_num, String project, String app_name, String options, String label, String column,
					String type, String mandatory, String value) {
				this.seq_num = seq_num;
				this.project = project;
				this.app_name = app_name;
				this.options = options;
		...
		class TriageSummary {
			...
			TriageSummary(int seq_num, String project, String app_name, String options, String label, String column,
					String type, String mandatory, String value) {
				this.seq_num = seq_num;
				this.project = project;
				this.app_name = app_name;
		...
		class Assessment {
			...
			Assessment(int seq_num, String project, String app_name, String section, String options, String label,
					String column, String type, String mandatory, String value) {
				this.seq_num = seq_num;
				this.project = project;
				this.app_name = app_name;
		...
		class rolesRespons {
			...
			rolesRespons(int seq_no, String role, String name, String email, String username, String priority,
					String approverPurpose) {
				this.seq_no = seq_no;
				this.role = role;
				this.name = name;
				this.email = email;
		...
		try {
			...
			if (dum == 0) {
				String q = " insert into dummy (value)" + " values (?)";
			...
			if (!rs_opportunity.next()) {
				...
				opportunity[1] = new OpportunityDetails(2, "", "", "", "Application Name", "appName", "Text box", "Yes",
						"");
				opportunity[2] = new OpportunityDetails(3, "", "", "", "Creation Date", "creation_date", "Datepicker",
						"No", "");
				...
				opportunity[5] = new OpportunityDetails(6, "", "", ",Archive,Decommission,Archive+Decommission",
						"Request Type", "request_type", "Dropdown", "Yes", "");
				opportunity[6] = new OpportunityDetails(7, "", "", "", "Requester", "requester", "Text box", "Yes", "");
				opportunity[7] = new OpportunityDetails(8, "", "", "", "Application Description", "appdesc", "Text box",
						"No", "");
				opportunity[8] = new OpportunityDetails(9, "", "", "", "Application Owner", "appowner", "Text box",
						"Yes", "");
				opportunity[9] = new OpportunityDetails(10, "", "", "", "Business Owner", "businessowner", "Text box",
						"No", "");
				opportunity[10] = new OpportunityDetails(11, "", "", "", "Development Owner/SME", "sme", "Text box",
						"Yes", "");
				opportunity[11] = new OpportunityDetails(12, "", "", "", "Billing Code", "billcode", "Text box", "No",
						"");
				opportunity[12] = new OpportunityDetails(13, "", "", "", "Business Segment", "businesssegment",
						"Text box", "No", "");
				opportunity[13] = new OpportunityDetails(14, "", "", "", "Business Unit", "businessunit", "Text box",
						"No", "");
				opportunity[14] = new OpportunityDetails(15, "", "", "", "Key Function", "keyfunction", "Text box",
						"No", "");
				opportunity[15] = new OpportunityDetails(16, "", "", "", "Program or Segment Contact", "pscontact",
						"Text box", "No", "");
				opportunity[16] = new OpportunityDetails(17, "", "",
						",EMR System,ERP Data,Financial Data,Healthcare Data,HR Data,MR/HR Data,Other Data",
						"Data Type", "date_type", "Dropdown", "No", "");
				opportunity[17] = new OpportunityDetails(18, "", "", "", "If Other Data", "if_other_data", "Text box",
						"No", "");
				opportunity[18] = new OpportunityDetails(19, "", "", "",
						"Please describe your needs for archival and decommission service", "arcdecomm", "Text box",
						"No", "");
				opportunity[19] = new OpportunityDetails(20, "", "", "", "Desired Completion Date", "completion_date",
						"Datepicker", "No", "");
			...
			if (!rs_governance.next()) {
				...
				governance[3] = new GovernanceDetails(4, "", "Planned Completion Date", "completion_date", "Datepicker",
						"No", "");
			...
			if (!rs_Triage.next()) {
				...
				Details[9] = new Triage(10, "", "", "", "Program or Segment Contact", "segment_contact", "Text box",
						"No", "");
				...
				Details[15] = new Triage(16, "", "", "", "Project Decomission Date", "Decom_date", "Datepicker", "Yes",
						"");
				Details[16] = new Triage(17, "", "", ",Yes,No", "Infrastructure Impact", "infrastructure_impact",
						"Dropdown", "No", "");
				Details[17] = new Triage(18, "", "", "", "Number of Infrastructure Components",
						"nmbr_of_infrastructure_components", "Text box", "No", "");
				...
				Details[21] = new Triage(22, "", "", ",Replace,Retire,Combine,Other", "Rationalization Type",
						"rationalization_type", "Dropdown", "No", "");
				Details[22] = new Triage(23, "", "", "", "If other, please describe ", "If_other_please_describe",
						"HiddenText", "Yes", "");
				Details[23] = new Triage(24, "", "", ",Mainframe,Distributed - Unix,Windows,hybrid,Others",
						"Application platform", "appPlatfrm", "Dropdown", "Yes", "");
				Details[24] = new Triage(25, "", "", "", "If Other,please describe ", "If_Other_describe", "HiddenText",
						"Yes", "");
				Details[25] = new Triage(26, "", "", "Yes,No", "Is application and Data hosted externally?",
						"app_and_data_hosted", "Radio box", "No", "");
				Details[26] = new Triage(27, "", "", "", "If yes,vendor?Location?", "vendor", "HiddenText", "Yes", "");
				Details[27] = new Triage(28, "", "", "Yes,No",
						"Are there any compliance or legal drivers determining retirement by a certain date ",
						"compliance", "Radio box", "No", "");
				Details[28] = new Triage(29, "", "", "", "If yes above,please describe", "describe", "HiddenText",
						"Yes", "");
				Details[29] = new Triage(30, "", "", "Yes,No",
						"Are there any business or financial drivers determining retirement by a certain date?Eg.,contract expiring",
						"Financialdate", "Radio box", "No", "");
				Details[30] = new Triage(31, "", "", "", "If Yes above,please describe", "plsdescribe", "HiddenText",
						"Yes", "");
				Details[31] = new Triage(32, "", "", "Yes,No",
						"Are there any technical drivers determining retirement by a certain date?.(Eg server end of life ,support,software,end of life,support)",
						"TechincalDeterminingdate", "Radio box", "No", "");
				Details[32] = new Triage(33, "", "", "", "If Yes above, please describe ", "pls_describe", "HiddenText",
						"Yes", "");
				Details[33] = new Triage(34, "", "", "", "Please describe business need/use for Archival",
						"useforArchival", "Text box", "No", "");
				Details[34] = new Triage(35, "", "", "", "Please describe at high-level your applications data ",
						"highlevelapplicationdata", "Text box", "No", "");
			...
			if (!rsTriSumm.next()) {
				...
				Trisumm[3] = new TriageSummary(4, "", "", "", "Project Task Number ", "PrjctTaskNumber", "Text box",
						"No", "");
			...
			if (!rsAbbTemp.next()) {
				...
				AbbTemplate[2] = new AbbTemplate(3, "IA",
						"InfoArchive is a repository that compresses and maintains data from business applications and data sources.Data contained within the archive is no longer transactional and immutable (unable to be changed).");
				AbbTemplate[3] = new AbbTemplate(4, "Read-Only",
				...
				AbbTemplate[4] = new AbbTemplate(5, "XML",
						"Extensible Markup Language is a markup language that is used to structure, store, and transport data across different applications and platforms.XML uses tags to describe the data.It is highly extensible and adaptable to various data formats.");
			...
			if (!RsroleRes.next()) {
				...
				RoleResponse[0] = new rolesRespons(1, "Project Sponsor", "", "", "", "",
						"Approves the�document�from an overall�program�perspective");
				RoleResponse[1] = new rolesRespons(2, "Business Owner", "", "", "", "",
						"Approves the�document�from an overall project perspective");
				RoleResponse[2] = new rolesRespons(3, "Project Manager", "", "", "", "",
						"Approves the�document�from an overall project perspective");
				RoleResponse[3] = new rolesRespons(4, "System Architect", "", "", "", "",
						"Approves the�document�from an�architecture�perspective");
				RoleResponse[4] = new rolesRespons(5, "Technical Lead", "", "", "", "",
						"Approves the�document�from a�technical�perspective");
			...
			if (!AssDataCharrs.next()) {
				...
				Assdata[0] = new Assessment(1, "", "", DataChar, ",DB2, MS SQL, MySQL, Oracle, Sybase, Other",
						"Database type", "DatabaseType", "Dropdown", "Yes", "");
				Assdata[1] = new Assessment(2, "", "", DataChar, ",Flat File, Structured, Unstructured, Hybrid, Other",
						"Data Type Characteristics ", "DataTypeCharacteristics", "Dropdown", "Yes", "");
				Assdata[2] = new Assessment(3, "", "", DataChar, "",
						"Structured Data - Database size of the Application (stated in GB) ", "StrucDBsize", "Text box",
						"Yes", "");
				Assdata[3] = new Assessment(4, "", "", DataChar, "", "Structured Data - Number of tables (if known) ",
						"StrucNoofTables", "Text box", "No", "");
				Assdata[4] = new Assessment(5, "", "", DataChar, "",
						"Unstructured Data - Volume of data (stated in GB) ", "UnstrucDataVolume", "Text box", "Yes",
						"");
				Assdata[5] = new Assessment(6, "", "", DataChar, "",
						"Unstructured Data - Number of files (E.g Attachments) ", "UnstrucNoofFiles", "Text box", "No",
						"");
				Assdata[6] = new Assessment(7, "", "", DataChar, "", "Database Server Name (Data Location) ",
						"DBServerName", "Text box", "No", "");
				Assdata[7] = new Assessment(8, "", "", DataChar, "", "Database Names ", "DBNames", "Text box", "No",
						"");
				Assdata[8] = new Assessment(9, "", "", DataChar, "", "Table Names if appropriate ", "TableNames",
						"Text box", "No", "");
				Assdata[9] = new Assessment(10, "", "", DataChar, "", "DBA Contact ", "DBAContact", "Text box", "No",
						"");
				Assdata[10] = new Assessment(11, "", "", DataChar, "Yes,No",
						"Are there any datasets on mainframe  that this application uses? ", "DataSetMainframe",
						"RadioBoxDependencyYes", "No", "");
				Assdata[11] = new Assessment(12, "", "", DataChar, "", "If yes, please provide additional information",
						"plsprovideinfo", "TextBoxDependencyYes", "No", "");
				Assdata[12] = new Assessment(13, "", "", DataChar, "Yes,No",
						"Does this application generate any reports to other systems? ", "ReportGeneration",
						"RadioBoxDependencyYes", "No", "");
				Assdata[13] = new Assessment(14, "", "", DataChar, "", "If yes, please provide details ",
						"plsprovidedetails", "TextBoxDependencyYes", "No", "");
				Assdata[14] = new Assessment(15, "", "", DataChar, "", "File share location (unstructured) ",
						"FileShareLocation", "Text box", "No", "");
				Assdata[15] = new Assessment(16, "", "", DataChar, "Yes,No",
						"Data is static (no updates are being made) ", "StaticData", "Radio box", "Yes", "");
				Assdata[16] = new Assessment(17, "", "", DataChar, "Yes,No",
						"Data is in Read Only State (no updates can be made) ", "ReadonlyData", "Radio box", "No", "");
				Assdata[17] = new Assessment(18, "", "", DataChar, "", "If yes, when was the last updates made? ",
						"LastUpdateMade", "DatepickerDependency", "No", "");
				Assdata[18] = new Assessment(19, "", "", DataChar, "", "If no, when is it expected to be read only? ",
						"ExpectedDate", "DatepickerDependency", "No", "");
				Assdata[19] = new Assessment(20, "", "", DataChar,
						",PCI,SOX,Consumer PII,Customer PII,Associate PII,SSN,None", "Application  Data ",
						"ApplicationData", "Dropdown", "No", "");
				Assdata[20] = new Assessment(21, "", "", DataChar, "Yes,No", "Upstream/Downstream dependencies ",
						"UpDownStream", "RadioBoxDependencyYes", "Yes", "");
				Assdata[21] = new Assessment(22, "", "", DataChar, "", "If yes, please describe ", "plsdescribeStreams",
						"TextBoxDependencyYes", "No", "");
				Assdata[22] = new Assessment(23, "", "", DataChar, "",
						"Date Range (age of records, e.g., 2009 - May, 2019) ", "Datepicker", "Text box", "No", "");
			...
			if (!AssessmentRs.next()) {
				...
				AssessmentDetails[0] = new Assessment(1, "", "", ComplianceChar, "", "Retention Category",
						"retentioncategory", "Text box", "No", "");
				AssessmentDetails[1] = new Assessment(2, "", "", ComplianceChar, "", "Record Type", "recordtype",
						"Text box", "No", "");
				AssessmentDetails[2] = new Assessment(3, "", "", ComplianceChar, "", "Retention Period",
						"retentionperiod", "Text box", "No", "");
				AssessmentDetails[3] = new Assessment(4, "", "", ComplianceChar, "Yes,No", "Archival Required?",
						"archivalrequired", "Radio box", "No", "");
				AssessmentDetails[4] = new Assessment(5, "", "", ComplianceChar, "",
						"Remaining Retention Period (if applicable)", "remainingretentionperiod", "Datepicker", "Yes",
						"");
				AssessmentDetails[5] = new Assessment(6, "", "", ComplianceChar, "",
						"Special Data Retention Requirements", "specialdataretention", "Text box", "No", "");
				AssessmentDetails[6] = new Assessment(7, "", "", ComplianceChar, "Yes,No", "Legal Hold", "legalhold",
						"RadioBoxDependencyYes", "Yes", "");
				AssessmentDetails[7] = new Assessment(8, "", "", ComplianceChar, "", "If any, please describe details",
						"ifanypleasedescribe", "TextBoxDependencyYes", "No", "");
				AssessmentDetails[8] = new Assessment(9, "", "", ComplianceChar, "Yes,No",
						"Are there any pending litigations that impacts the retirement of the application and data",
						"retirementappanddata", "Radio box", "Yes", "");
				AssessmentDetails[9] = new Assessment(10, "", "", ComplianceChar, ",On Hold,Pending review,Cleared,N/A",
						"Legal Status", "legalstatus", "Dropdown", "No", "");
				AssessmentDetails[10] = new Assessment(11, "", "", ComplianceChar, "Yes,No",
						"Any specific purge requirements?", "specificpurgerequirements", "RadioBoxDependencyYes", "Yes",
						"");
				AssessmentDetails[11] = new Assessment(12, "", "", ComplianceChar, "",
						"If any, please describe details", "describedetails", "TextBoxDependencyYes", "No", "");
			...
			if (!AssArchivalrs.next()) {
				...
				AssessmentArchiv[0] = new Assessment(1, "", "", ArchivConsump,
						",Frequent users with Online Inquiry, Retention for Audit purposes, Ad-hoc reporting, Long-term Retention Only",
						"Archival needs", "archiveneed", "Dropdown", "Yes", "");
				AssessmentArchiv[1] = new Assessment(2, "", "", ArchivConsump, "",
						"How many users are expected to use the InfoArchive system after archival?",
						"archivalusercount", "Text box", "Yes", "");
				AssessmentArchiv[2] = new Assessment(3, "", "", ArchivConsump, "", "Number of concurrent users",
						"concurrentuser", "Text box", "No", "");
				AssessmentArchiv[3] = new Assessment(4, "", "", ArchivConsump, "",
						"Estimated number of search forms (screens) needed in the archive ", "noofsearch", "Text box",
						"Yes", "");
				AssessmentArchiv[4] = new Assessment(5, "", "", ArchivConsump, "",
						"Please describe any known Search screen requirements", "plsdescscrreq", "Text box", "Yes", "");
				AssessmentArchiv[5] = new Assessment(6, "", "", ArchivConsump, "", "Frequency of search", "searchfreq",
						"Text box", "No", "");
				AssessmentArchiv[6] = new Assessment(7, "", "", ArchivConsump, "",
						"Format of results (e.g., online, report, etc.)", "resformat", "Text box", "Yes", "");
				AssessmentArchiv[7] = new Assessment(8, "", "", ArchivConsump, "", "Response time requirement",
						"responsetime", "Text box", "No", "");
				AssessmentArchiv[8] = new Assessment(9, "", "", ArchivConsump, "Yes,No", "Encryption?", "enc",
						"Radio box", "Yes", "");
				AssessmentArchiv[9] = new Assessment(10, "", "", ArchivConsump, "Yes,No", "Data Masking?", "datamask",
						"Radio box", "Yes", "");
			...
			if (!AssessAppInfoRs.next()) {
				...
				AssessmentDetails[0] = new Assessment(1, "", "", AppInfo,
						",COTS - Commercial Off The Shelf,MOTS - Modified Off The Shelf,Custom - In-house Development",
						"Application Details", "AppDetails", "Dropdown", "Yes", "");
				AssessmentDetails[1] = new Assessment(2, "", "", AppInfo,
						",Currently supported,Nearing end of life,End of life with extended support/maintenance,unsupported",
						"Lifecycle", "Lifecycle", "Dropdown", "No", "");
				AssessmentDetails[2] = new Assessment(3, "", "", AppInfo, "Yes,No",
						"Is this a currently supported application?", "SupportedApp", "RadioBoxDependencyNo", "No", "");
				AssessmentDetails[3] = new Assessment(4, "", "", AppInfo, "", "If NO,who supports this Application?",
						"SupportApp", "TextBoxDependencyNo", "No", "");
				AssessmentDetails[4] = new Assessment(5, "", "", AppInfo, "Yes,No",
						"Operational support staff/SME's available for analysis?", "OperationalSupportStaff",
						"Radio box", "No", "");
				AssessmentDetails[5] = new Assessment(6, "", "", AppInfo,
						",Mainframe,Distributed - Unix,Windows,hybrid,Others", "Application platform",
						"AssessAppPlatform", "Dropdown", "Yes", "");
				AssessmentDetails[6] = new Assessment(7, "", "", AppInfo, "", "If Other,please describe ",
						"OtherPleaseDescribe", "Text box", "No", "");
				AssessmentDetails[7] = new Assessment(8, "", "", AppInfo, "", "Brief architecture description",
						"BriefArchitectureDescription", "TextAreaFile", "No", "");
				AssessmentDetails[8] = new Assessment(9, "", "", AppInfo, "", "Application Hosting Vendor", "AppHost",
						"Text box", "No", "");
				AssessmentDetails[9] = new Assessment(10, "", "", AppInfo, "", "Application Supporting Vendor",
						"AppSupport", "Text box", "No", "");
				AssessmentDetails[10] = new Assessment(11, "", "", AppInfo, "", "Decommission Readiness Date",
						"DecomReadiness", "Datepicker", "No", "");
				AssessmentDetails[11] = new Assessment(12, "", "", AppInfo, "", "Data Migration complete",
						"DataMigrationComplete", "Datepicker", "No", "");
				AssessmentDetails[12] = new Assessment(13, "", "", AppInfo, "", "Data Migrated to <application name>:",
						"DataMigrateApp", "Text box", "No", "");
				AssessmentDetails[13] = new Assessment(14, "", "", AppInfo, "Yes,No",
						"Are there any compliance or legal drivers determining retirement by a certain date?",
						"ComplianceLegalDrivers", "RadioBoxDependencyYes", "No", "");
				AssessmentDetails[14] = new Assessment(15, "", "", AppInfo, "", "If Yes above, please describe",
						"PleaseDescribe1", "TextBoxDependencyYes", "No", "");
				AssessmentDetails[15] = new Assessment(16, "", "", AppInfo, "Yes,No",
						"Are there any business or financial drivers determining retirement by a certain date?",
						"BusinessDriversDrivers", "RadioBoxDependencyYes", "No", "");
				AssessmentDetails[16] = new Assessment(17, "", "", AppInfo, "", "If Yes above, please describe",
						"PleaseDescribe2", "TextBoxDependencyYes", "No", "");
				AssessmentDetails[17] = new Assessment(18, "", "", AppInfo, "Yes,No",
						"Are there any technical drivers determining retirement by a certain date?", "TechnicalDrivers",
						"RadioBoxDependencyYes", "No", "");
				AssessmentDetails[18] = new Assessment(19, "", "", AppInfo, "", "If Yes above, please describe",
						"PleaseDescribe3", "TextBoxDependencyYes", "No", "");
			...
			if (!AssessContractInfoRs.next()) {
				...
				AssessmentDetails[0] = new Assessment(1, "", "", ContractInfo, "", "Contract:  Vendor Name",
						"VendorName", "Text box", "Yes", "");
				AssessmentDetails[1] = new Assessment(2, "", "", ContractInfo, "", "Contract:  Vendor Contact Name",
						"VendorContactName", "Text box", "No", "");
				AssessmentDetails[2] = new Assessment(3, "", "", ContractInfo, "", "Contract:  App Name",
						"ContractAppName", "Text box", "Yes", "");
				AssessmentDetails[3] = new Assessment(4, "", "", ContractInfo, "", "Contract:  Expiration Date",
						"ExpirationDate", "Datepicker", "Yes", "");
				AssessmentDetails[4] = new Assessment(5, "", "", ContractInfo, "", "Contract Termination Notice Period",
						"TerminationNoticePeriod", "Text box", "No", "");
			...
			if (!RsBusReqInScope.next()) {
				...
				BusreqinscopeDetails[0] = new BusinessReqInScope(1, "Yes/Y",
						"Requirements in-scope for this archive project and is marked in Requirement Table accordingly");
				BusreqinscopeDetails[1] = new BusinessReqInScope(2, "No/N",
						"Requirements out-scope for this archive project and is marked in Requirement Table accordingly");
			...
			String[] tableNamesFunctionReq = { "Archive_DataReq_Template_Details",
					"Archive_RetentionLegalReq_Template_Details", "Archive_SecurityReq_Template_Details",
					"Archive_UsabilityReq_Template_Details", "Archive_AuditlReq_Template_Details" };
			for (int index = 0; index < tableNamesFunctionReq.length; index++) {
				archiveFunDataReqTemplate archiveDataReqObj = new archiveFunDataReqTemplate(
						tableNamesFunctionReq[index]);
			...
			try {
				...
				if (rs2.next()) {
					...
					if (username.equals(dbuname) && user_fname.equals(dbufname) && userLastnameMatched
						...
						PreparedStatement lc = con
								.prepareStatement("select license_info from license ORDER BY id DESC LIMIT 1");
					...
					response.sendRedirect("Login_Error.jsp?ErrorMessage=" + msg);// user you have entered not
																					// registered.
				}
